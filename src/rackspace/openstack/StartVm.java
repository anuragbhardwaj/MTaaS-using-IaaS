 ...
 */
public class StartVm implements Closeable {
   ...
   public void startInstance(String vmId) {
	...
	// Authentication in jclouds is lazy and happens on the first call to the cloud.
       ...
       try{
           ...
           String sqlDelete = "update virtualmachine set isStopped = ? where vmId = ?";
           ...
           preparedStatement.setString(2,tempVirtualMachineID);
