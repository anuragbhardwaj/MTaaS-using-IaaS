 ...
 <div class="navbar navbar-inverse navbar-fixed-top">
      <div class="container">
        ...
        <div class="collapse navbar-collapse">
         ...
         <p style="color:white;">Welcome,<c:out value="${currentSessionUser.firstName}" />
            <button  class="btn btn-success" onclick="location.href='/CmpE295B/Login?action=logout'">Logout</button>
          </p>
          </div>
        </div>
      </div>
    	  		...
    	  		<div class="control-group">
            		...
            		<div class="controls">
              			<input class="input-xlarge focused" id="focusedInput" type="text" name="username"
            				value="<c:out value="${currentSessionUser.firstName}" />">
            		</div>
          		</div> 
            	<div class="control-group">
